 ...
 */
public class WaveSideBar1 extends View {
    ...
    public WaveSideBar1(Context context) {
        this(context, null);
    }

    public WaveSideBar1(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public WaveSideBar1(Context context, AttributeSet attrs, int defStyleAttr) {
